		...
		<div class="overflow-x-auto">
			<table class="table table-zebra">
				...
				<tbody>
					...
					<tr>
						<td>Fajr</td>
						<td>{data.iqama.find((iq) => iq.prayer_name.toLowerCase() === 'fajr')?.iqama_time}</td>
					</tr>
					<!-- row 2 -->
					<tr>
						<td>Dhuhr</td>
						<td>{data.iqama.find((iq) => iq.prayer_name.toLowerCase() === 'dhuhr')?.iqama_time}</td>
					</tr>
					<!-- row 3 -->
					<tr>
						<td>Asr</td>
						<td>{data.iqama.find((iq) => iq.prayer_name.toLowerCase() === 'asr')?.iqama_time}</td>
					</tr>
					<tr>
						<td>Maghrib</td>
						<td
					...
					<tr>
						<td>Isha</td>
						<td>{data.iqama.find((iq) => iq.prayer_name.toLowerCase() === 'isha')?.iqama_time}</td>
					</tr>
				</tbody>
			</table>
